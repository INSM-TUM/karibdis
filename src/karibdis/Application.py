...
def DiscoveryUI(importer, log, run_extraction):
    ...
    allowed_templates, set_allowed_templates = reacton.use_state(['init', 'chainresponse', 'exactly_one', 'responded_existence', 'response', 'precedence']) # TODO allow user to specify this
    if not declare:
